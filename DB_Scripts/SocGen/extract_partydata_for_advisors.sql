...
BEGIN
    ...
    SELECT 
        ...
        t3.partyidentifiervalue AS fa_rep_num
		---- CASE 
		---- 	-- WHEN t1.partyoriginuser = '117' THEN cleanup_whitespace(t1.partyname)::VARCHAR
		---- 	WHEN t1.partyoriginuser IN ('025') THEN t4.partycontactfirstname
		---- 	ELSE NULL                        
		---- END AS fa_name_1,                    
		---- CASE                                 
		---- 	WHEN t1.partyoriginuser IN ('025') THEN t4.partycontactlastname
		---- 	ELSE NULL
		---- END AS fa_name_2,
        ...
        ---- 
		---- 	WHEN t1.partyoriginuser IN ('025') THEN 
		---- 		'Phone: ' || 
		---- 		CASE 

-- FUNCTION: public.extract_summary_details_from_balance(text, text, text, text, text)

-- DROP FUNCTION IF EXISTS public.extract_summary_details_from_balance(text, text, text, text, text);

CREATE OR REPLACE FUNCTION public.extract_summary_details_from_balance(
...
ALTER FUNCTION public.extract_summary_details_from_balance(text, text, text, text, text)
    OWNER TO "DBUser";

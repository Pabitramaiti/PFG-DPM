-- FUNCTION: public.extract_summary_details_from_non_balance_for_asset_alloc(text, text, text, text, text)

-- DROP FUNCTION IF EXISTS public.extract_summary_details_from_non_balance_for_asset_alloc(text, text, text, text, text);

CREATE OR REPLACE FUNCTION public.extract_summary_details_from_non_balance_for_asset_alloc(
...
ALTER FUNCTION public.extract_summary_details_from_non_balance_for_asset_alloc(text, text, text, text, text)
    OWNER TO "DBUser";

CREATE OR REPLACE FUNCTION public.create_json_for_party_interested_parties(
p_identifier_value text, p_partyid bigint, clientid text, origin text)
 RETURNS VOID
 LANGUAGE plpgsql
AS $function$
DECLARE
...
BEGIN
    ...
    JOIN partyclassification t3
		...
		AND t3.partyclassificationvalue='InterestedParty'
    ...
    JOIN partycontact t5
		...
		AND t5.partycontacttype = 'InterestedParty'
    ...
    WHERE t1.partyparentid = p_partyid

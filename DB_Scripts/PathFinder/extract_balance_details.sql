CREATE OR REPLACE FUNCTION public.extract_balance_details(p_identifier_value text, clientid text, origin text, balance_identifier_type text, balance_identifier_value text)
 RETURNS void
 LANGUAGE plpgsql
AS $function$
BEGIN

...
def main():
    ...
    # task_definition_name = "br_icsdev_dpmtest_director_core_jhi-brx-jsonconvertor_8c9e2891:1"
    # container_name = "director_core_jhi-brx-jsonconvertor"
                ...
                'containerOverrides': [
                    {
                        'name': container_name,
                        "command": [
                            "java", "-jar", os.getenv("build_jar"),
                            "-pattern", os.getenv("file_pattern"),
                            "-inputbucket", os.getenv("inputbucket"),
...
if __name__ == "__main__":
    main()
# ["java","-jar","brx-json-convertor-0.0.1-SNAPSHOT.jar","-pattern","^(?i)(JSC\\.YETAX\\.\\d{8}\\.\\d{6}\\.json)$","-inputbucket","br-icsdev-fcsatest-fcsa-pp-us-east-1-s3","-key","jhi/taxes/wip/281c39b8-4910-451f-8c48-125bc4a67add","-outputbucket","br-icsdev-fcsatest-fcsa-pp-us-east-1-s3","-outputpath","jhi/taxes/wip/281c39b8-4910-451f-8c48-125bc4a67add"]